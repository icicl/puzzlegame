...
public class draw extends JPanel{
	...
	private void paintNum(Graphics g,int i,int j,int num,Color c){
		paintNum(g,i,j,num,c,true,0);
	}
	private void paintNum(Graphics g,int i,int j,int num,Color c,boolean overwrite,int displacement){
		if (overwrite){
		g.setColor(c);
		...
		if (num == 1)
		{
			g.drawLine(i * 20 + displacement +13, j * 20 + 5, i * 20 + displacement +13, j * 20 + 9);	//3
			g.drawLine(i * 20 + displacement +13, j * 20 + 11, i * 20 + displacement +13, j * 20 + 15);	//6
		}
		else if (num == 2)
		{
			g.drawLine(i * 20 + displacement +8, j * 20 + 4, i * 20 + displacement +12, j * 20 + 4);	//2
			g.drawLine(i * 20 + displacement +13, j * 20 + 5, i * 20 + displacement +13, j * 20 + 9);	//3
			g.drawLine(i * 20 + displacement +8, j * 20 + 10, i * 20 + displacement +12, j * 20 + 10);	//4
			g.drawLine(i * 20 + displacement +7, j * 20 + 11, i * 20 + displacement +7, j * 20 + 15);	//5
			g.drawLine(i * 20 + displacement +8, j * 20 + 16, i * 20 + displacement +12, j * 20 + 16);	//7
		}
		else if (num == 3)
		{
			g.drawLine(i * 20 + displacement +8, j * 20 + 4, i * 20 + displacement +12, j * 20 + 4);	//2
		...
		{
			g.drawLine(i * 20 + displacement +7, j * 20 + 5, i * 20 + displacement +7, j * 20 + 9);		//1
			g.drawLine(i * 20 + displacement +13, j * 20 + 5, i * 20 + displacement +13, j * 20 + 9);	//3
			g.drawLine(i * 20 + displacement +8, j * 20 + 10, i * 20 + displacement +12, j * 20 + 10);	//4
			g.drawLine(i * 20 + displacement +13, j * 20 + 11, i * 20 + displacement +13, j * 20 + 15);	//6
		}
...
//			g.drawLine(i * 20 + displacement +8, j * 20 + 10, i * 20 + displacement +12, j * 20 + 10);	//4
			...
			g.drawLine(i * 20 + displacement +6, j * 20 + 5, i * 20 + displacement +6, j * 20 + 9);	//3
			g.drawLine(i * 20 + displacement +6, j * 20 + 11, i * 20 + displacement +6, j * 20 + 15);	//6
			if (num==11)
				paintNum(g,i,j,num-10,c,false,1);			
			
			else paintNum(g,i,j,num-10,c,false,3);
		}

		else{
			System.out.println("BIG OOF"+num);
		}
